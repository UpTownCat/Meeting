var prefixUrl = "/meeting/room/day/";
var CalendarHandler = {
    currentYear: 0,
    currentMonth: 0,
    isRunning: false,
    showYearStart:2009,
    tag:0,
    initialize: function(myYear, myMonth, myDay) {
        $calendarItem = this.CreateCalendar(myYear, myMonth, myDay);
    ...
    CreateCalendar: function(y, m, d) {
        ...
        if(y==nowDate.getFullYear()&&m==nowDate.getMonth()+1&&d==nowDate.getDate()||(y==0&&m==0))
            $(".currentDay").hide();
        ...
        var nowMonthStr = nowMonth < 10 ? "0" + nowMonth : "" + nowMonth;
        this.initlizeUrl(nowYear, nowMonthStr, d);
        ...
        for (var i = 0; i < nowDaysNub; i++) {
            ...
            var str = "" + myYear + myMonth + myDate3;
            //if (i == (nowDay - 1) && myDate2.getMonth() + 1 == parseInt(myMonth)) $dayItem.append("<div class=\"item currentItem\"><a>" + (i + 1) + "</a></div>");
            if (i == (nowDay - 1) ) $dayItem.append("<div class=\"item currentItem\"><a href='" + prefixUrl + str + "'>" + (i + 1) + "</a></div>");
            else $dayItem.append("<div class=\"item\"><a class='myA' href='" + prefixUrl + str + "' style='text-decoration: none'>" + (i + 1) + "</a></div>");
        }
    ...
    RunningTime: function() {
        var mTiming = setInterval(function() {
            ...
            var myMonth = nowDate.getMonth() < 9 ? "0" + (nowDate.getMonth() + 1) : (nowDate.getMonth() + 1);
            var myDate = nowDate.getDate()< 10 ? "0" + nowDate.getDate(): nowDate.getDate();
            ...
            var nowTime = myYear + "-" + myMonth + "-" + myDate + "  " + h + ":" + m + ":" + s;
            $("#footNow").html(nowTime);
        }, 1000);
    },
    
    initlizeUrl: function(y, m, d) {
    	...
    	monthView.attr("href", "/meeting/room/month/" + y + m);
    	weekView.attr("href", "/meeting/room/week/" + y + m + myDay);
    },
}
/**
